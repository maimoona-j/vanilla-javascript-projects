...
nextBtn2.addEventListener("click", function (e) {
  ...
  if (advancePayment) {
    ...
    form3.querySelector("#t-cost3 p").textContent =
      form2.querySelector("#t-cost p").textContent;
    form3.querySelector("#d3 p").textContent = advancePayment;
    ...
    alert("Please provide the advance payment before proceeding.");
  }
});
